...
<body>
	...
	<script type="text/javascript"
		src="<c:url value='resource/editor/js/HuskyEZCreator.js'/>"
	...
	<h2>IDEA BOARD</h2>
	<hr>
	<p>반짝이는 아이디어를 올려주세요!</p></div><br>
		<br>
		<div style="width: 660px; margin: auto;">
			<form role="form" action="ideaUpdate.do" method="post" id="frm">
				<input type="hidden" name="idea_num" value="${vo.idea_num }">
				<div class="form-group">
					<label for="idea_title"> 제목</label> <input type="text"
						class="form-control" id="idea_title" name="idea_title"
						value="${vo.idea_title }" required="required">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<textarea required="required" id="ir1" name="idea_content"
						style="width: 650px; height: 350px;">${vo.idea_content }</textarea>
				</div>

				<p align="center">
					<button type="button" id="savebutton"
						class="btn btn-warning btn-sm">작성완료</button>
				</p>
			</form>
		</div>
	</div>
