...
//	iMinUndoInterval : 50,
	...
	$init : function(iframe){
		...
		this.sBlankPageURL = "/controller/resource/editor/smart_editor2_inputarea.jsp";
		this.sBlankPageURL_EmulateIE7 = "/controller/resource/editor/smart_editor2_inputarea_ie8.jsp";
	...
	initIframe : function(){
		try {
			...
			if (sCSSBaseURI){
				...
				linkNode.href = sCSSBaseURI + '/controller/resource/editor/css/smart_editor2_in.css';
...
nhn.husky.SE2B_CSSLoader = jindo.$Class({
	...
	*/
	...
	loadSE2CSS : function(sMsg, oArgs){
		...
		nhn.husky.SE2M_Utils.loadCSS("/controller/resource/editor/css/smart_editor2_items.css", fnCallback);
