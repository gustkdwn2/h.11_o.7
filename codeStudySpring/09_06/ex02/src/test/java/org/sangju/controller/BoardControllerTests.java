...
public class BoardControllerTests {
	 ...
	 * "TEST NEW TITLE") .param("content", "TEST NEW CONTENT").param("writer",
	 ...
	 * .param("title", "TEST UPDATE TITLE") .param("content",
	 * "TEST UPDATE CONTENT").param("writer", "user00"))
	...
	public void testRemove() throws Exception {
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/remove").param("bno", "42")).andReturn()
