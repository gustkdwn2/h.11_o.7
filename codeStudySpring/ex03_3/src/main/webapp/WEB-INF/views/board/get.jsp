	...
	<div class="col-lg-12">
        ...
        <a href="/board/list">List</a></button> --%>
				...
				<form id='operForm' action="/boad/modify" method="get">
					...
					<input type='hidden' name='keyword' value='<c:out value="${cri.keyword}"/>'> <input type='hidden'
		...
		.ready(
			function () {
				...
				function showReplyPage(replyCnt) {
					var endNum = Math.ceil(pegeNum / 10.0) * 10;
					...
					if (prev) {
						str += "<ul class='page-item'><a class='page-link' href='" + (startNum - 1) +
						"'>Previous</a></li>";
					}
					...
					if (next) {
						str += "<li class='page-item'><a class='page-link' href='" + (endNum + 1) + "'>" + Next +
							"</a></li>";
					}
					str += "</ul></div>";
					console.log(str);
