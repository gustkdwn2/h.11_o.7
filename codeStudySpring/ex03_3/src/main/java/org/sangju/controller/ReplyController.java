...
public class ReplyController {
	...
	public ResponseEntity<String> create(@RequestBody ReplyVO vo) {
		...
		return insertCount == 1 ? new ResponseEntity<String>("succes", HttpStatus.OK)
				: new ResponseEntity<String>(HttpStatus.INTERNAL_SERVER_ERROR);
	}

	@GetMapping(value = "/pages/{bno}/{page}", headers = "Accept=*/*", produces = { MediaType.APPLICATION_XML_VALUE,
